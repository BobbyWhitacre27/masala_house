...
const Cart = ({	setTandoriChickenWings, tandoriChickenWings, 
	...
	const itemsInCart = [	setTandoriChickenWings, tandoriChickenWings, 
		setVegetableSamosas, vegetableSamosas,
		setPaneerPakora, paneerPakora,
		setLentilsSoup, lentilsSoup,
		setNaan, nann,
	...
	const totalItemsInCart = itemsInCart.reduce(add, 0)
                ...
                <div class="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8">
                    <div class="mx-auto max-w-3xl">
                        <header class="text-center">
                            <h1 class="text-xl font-bold text-red-700 sm:text-3xl">Cart</h1>
                        </header>
                        Tandori Chicken Wings: {tandoriChickenWings}
                        <div class="mt-8">
                            <ul class="space-y-4">
                            ...
                            <div class="mt-8 flex justify-end border-t border-gray-100 pt-8">
                                <div class="w-screen max-w-lg space-y-4">
                                    <dl class="space-y-0.5 text-sm text-gray-700">
                                        ...
                                        <div class="flex justify-between !text-base font-medium  border-2">
                                            <dt>Total</dt>
                                            <dd>£200</dd>
                                        </div>
                                    </dl>
